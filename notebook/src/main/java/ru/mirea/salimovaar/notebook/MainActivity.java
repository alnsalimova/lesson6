package ru.mirea.salimovaar.notebook;
...
import ru.mirea.salimovaar.notebook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void writeFileToExternalStorage() {
        ...
        try {
            ...
            output.write(String.valueOf(binding.line.getText()));
            output.close();
        } catch (IOException e) {
    ...
    public void readFileFromExternalStorage() {
        ...
        try {
            ...
            binding.line.setText(lines.toString());
        } catch (Exception e) {
